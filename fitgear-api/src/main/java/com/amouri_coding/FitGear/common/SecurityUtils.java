...
public class SecurityUtils {
    ...
    // Verifies that the Authentication object is a client
    public static Client getAuthenticatedClient(Authentication authentication) {
        ...
        if (authentication.getAuthorities().stream()
            ...
            log.error("You are not a client");
            throw new AccessDeniedException("You are not a client");
        }

        Client connectedClient = (Client) authentication.getPrincipal();
