...
public class JwtService {
    ...
    public void initKeys() throws Exception {
        ...
        try {
            this.privateKey = loadPrivatekey("fitgear-api/src/main/resources/keys/private.pem");
            this.publicKey = loadPublicKey("fitgear-api/src/main/resources/keys/public.pem");
